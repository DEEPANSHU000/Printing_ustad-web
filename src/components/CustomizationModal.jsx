...
const APPAREL_KEYWORDS = ['shirt', 'tee', 't-shirt', 'hoodie', 'polo', 'cap', 'jacket'];
...
const PRODUCT_TEMPLATES = {
    ...
    // apparel: '/templates/blank_tshirt.png',  // add more later
};
    ...
    const handleAddToCart = async () => {
        ...
        if (canvas && finalUploadUrl) {
            try {
                ...
                const data = await response.json();
                if (response.ok) previewUrl = data.publicUrl;
            } catch (err) {
        ...
        onAddToCart({
            ...
            printScale,
            hasCustomDesign:   !!finalUploadUrl,
        });
